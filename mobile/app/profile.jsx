...
export default function ProfileScreen() {
  ...
  const [user, setUser] = useState(MOCK.dashboard.user);
    ...
    >
      ...
      <View style={styles.avatarRow}>
        <View style={styles.avatar}>
          <Text style={styles.avatarTxt}>{user.initials || 'RS'}</Text>
        </View>
        <View style={{ flex: 1 }}>
      ...
      <View style={styles.statGrid}>
        <View style={styles.statCard}>
          ...
          <Text style={[styles.statVal, { color: colors.text }]}>₹40</Text>
          <Text style={styles.statSub}>paid this week</Text>
        </View>
        <View style={styles.statCard}>
          <Text style={styles.statLbl}>RECEIVED</Text>
          <Text style={[styles.statVal, { color: colors.green }]}>₹500</Text>
          <Text style={styles.statSub}>in payouts</Text>
        </View>
      </View>

      <View style={styles.noteCard}>
        <Text style={styles.noteTxt}>You earned ₹12.5 for every ₹1 paid this week.</Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  rowVal: { fontSize: 13, fontWeight: '600', color: colors.text2 },
